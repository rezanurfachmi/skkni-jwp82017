...
if(isset($_POST['ucapan'])){
	...
	$db->insert('pesan',array(
								...
								'dtmcrt'=>wkt()
							)) or eksyen('Error MySQL Pesan: Hubungi Administrator','index.php');

	$db->insert('penerima',array(
								'idpenerima'=>id(),
								'idpesan'=>$id,
								'nama'=>$nama,
								'alamat'=>$alamat,
								...
								'usrcrt'=>$_SESSION['idpengguna'],
								'dtmcrt'=>wkt()
							)) or eksyen('Error MySQL Penerima: Hubungi Administrator','index.php');
		...
		<div class="row">
			...
			<div class="col-md-9">
						...
						<div class="panel-body">
							<div class="form-group">
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="ucapan" id="inputUcapan" class="form-control" value="" placeholder="Tuliskan ucapan." maxlength="50" autofocus>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<span id="helpBlock" class="help-block">Gambar akan dicetak menjadi ukuran A6.</span>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" name="nama" id="inputNama" class="form-control" value="" required="required" placeholder="Nama Penerima">
								</div>
							</div>
							<div class="form-group">
				...
				<p>
					...
					<button type="submit" class="btn btn-danger"><i class="fa fa-shopping-cart"></i> Beli</button>
				</p>
				</form>
			</div>
		</div>
